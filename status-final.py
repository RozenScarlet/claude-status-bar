...
# ================================
# 按量付费用户需要配置以下两项：
# 1. SESSION_COOKIE: 从浏览器开发者工具中获取的 session cookie 值
# 2. NEW_API_USER_ID: 从浏览器开发者工具中获取的 new-api-user 请求头值
# 详细获取方法请查看 README.md 中的"按量付费配置说明"部分

SESSION_COOKIE = "your-session-cookie-here"
NEW_API_USER_ID = "your-user-id-here"
